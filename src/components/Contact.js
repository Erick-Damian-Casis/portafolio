        ...
        <div>
            <div id="contact" className="flex min-h-screen items-center justify-start bg-white">
                <div className="mx-auto w-full max-w-lg">
                    ...
                    <p className="mt-3">Pedes enviarme un correo a ejc.damian@yavirac.edu.ec o enviarme un mensaje por aqui:</p>
                    <form action="https://api.web3forms.com/submit" className="mt-10">
                        ...
                        <button type="submit" className="mt-5 rounded-md bg-black px-10 py-2 text-white hover:bg-gray-700 hover:border-gray-700 hover:text-white focus-within:bg-gray-700 focus-within:border-gray-700 focus-within:text-white">Send Message</button>
                    </form>
                </div>
            </div>
        </div>
